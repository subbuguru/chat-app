          ...
          title: Column(
            ...
            children: [
              ...
              Text(widget.receiverDisplayname,
                  style: const TextStyle(fontSize: 13) // Adjust as needed
                  ),
            ],
          ),
          centerTitle: true,
  ...
  Widget _buildMessageItem(DocumentSnapshot doc) {
    ...
    if (isImage && content != null) {
      contentWidget = Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
              image: NetworkImage(doc["content"]), fit: BoxFit.cover),
        ),
      );
      ...
      contentWidget = Container(
          ...
          padding: const EdgeInsets.all(12),
          child: const Text(
            "Error: Text not loading, try again later.",
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              DateFormat('MMM d, h:mm a').format(doc['timestamp'].toDate()),
